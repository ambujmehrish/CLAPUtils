...
class MP3CompressionAugment(BaseWaveformTransform):
    ...
    def apply_lameenc(
        ...
        try:
            ...
            print(
                (
                    ...
                    "To install the optional lameenc dependency of CLAPForge,"
        ...
        assert input_samples.dtype == np.float32

        input_samples = self.maybe_pre_gain(input_samples)

        int_samples = convert_float_samples_to_int16(input_samples).T

        num_channels = 1 if input_samples.ndim == 1 else input_samples.shape[0]
        ...
        try:
            ...
            print(
                (
                    ...
                    "To install the optional pydub dependency of CLAPForge,"
                    " do `pip install CLAPForge[extras]` or simply"
                    " `pip install pydub`"
                ),
                file=sys.stderr,
