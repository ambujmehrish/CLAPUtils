...
class TimeMaskAugment(BaseWaveformTransform):
    """
    ...
    def __init__(
        ...
        :param fade: When set to True, a linear fade-in and fade-out is added to the silent part.
            This can smooth out unwanted abrupt changes between consecutive input_samples, which might
    ...
    def apply(self, input_samples: NDArray[np.float32], sample_rate: int) -> NDArray[np.float32]:
        new_samples = input_samples.copy()
        t = self.parameters["t"]
